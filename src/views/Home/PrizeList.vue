...
const { getIsShowPrizeList: isShowPrizeList, getImageList: localImageList } =
  ...
  <div class="flex items-center">
      ...
      <div class="modal-box">
        ...
        <div class="flex flex-col gap-3">
          ...
          <label class="flex w-full max-w-xs">
            ...
            <input
              v-model="temporaryPrize.isUsedCount"
              disabled
              type="number"
              :placeholder="t('placeHolder.winnerCount')"
              class="max-w-xs input-sm input input-bordered"
          ...
          <label
            v-if="temporaryPrize.separateCount"
          ...
          >
            ...
            <div
              ...
              @click="selectPrize(temporaryPrize)"
            >
              <ul
          ...
          <label class="flex w-full max-w-xs">
            ...
            <select
              v-model="temporaryPrize.picture"
              class="flex-1 w-12 select select-warning select-sm"
            >
              <option
                v-if="temporaryPrize.picture.id"
                :value="{ id: '', name: '', url: '' }"
              >
                ❌
              </option>
    ...
    <div ref="prizeListContainerRef">
      <div
        ...
        class="h-20 w-72"
        :class="temporaryPrize.isShow ? 'current-prize' : ''"
      >
        <div
        ...
        >
          ...
          <figure class="w-10 h-10 rounded-xl">
            <ImageSync
              v-if="temporaryPrize.picture.url"
              :img-item="temporaryPrize.picture"
            />
            <img
              v-else
      ...
      <transition name="prize-list" :appear="true">
        <div
          v-if="prizeShow && !isMobile && !temporaryPrize.isShow"
          class="flex items-center"
        >
          <ul
            ref="prizeListRef"
            class="flex flex-col gap-1 p-2 rounded-xl bg-slate-500/50 max-h-[800px] overflow-y-auto"
          >
            <li
          ...
          <div class="flex flex-col gap-3">
            ...
            <div
              class="tooltip tooltip-right"
              :data-tip="t('tooltip.addActivity')"
            >
              <div
                class="flex items-center w-6 h-8 rounded-r-lg cursor-pointer prize-option bg-slate-500/50"
                @click="addTemporaryPrize"
